...
- Copied and downloaded Markdown reports include every scanner finding with its severity, type, path, explanation, recommended action, and available metadata, plus the compact offline Dependency Trust summary and baseline changes.
