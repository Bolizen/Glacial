...
This guide describes Glacial 0.9.8. The application remains pre-v1 and `NOT READY`; these instructions do not make an unsigned or unapproved installer trustworthy.
